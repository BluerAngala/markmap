...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(em1, file, 33, 54, 648);
			add_location(em2, file, 33, 78, 672);
			attr_dev(h2, "class", "text-3xl font-medium mb-2 text-gray-500");
			add_location(h2, file, 33, 2, 596);
			add_location(p0, file, 36, 2, 773);
			add_location(strong, file, 38, 5, 798);
			add_location(p1, file, 38, 2, 795);
			attr_dev(a, "href", "repl");
			add_location(a, file, 39, 5, 862);
			add_location(p2, file, 39, 2, 859);
